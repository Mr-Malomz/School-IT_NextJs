				...
				>
					<div className='w-full'>
						...
						<p className='mt-4 mb-4 text-sm lg:text-base'>
							SchoolIT Technology is designed to automate a
							school's diverse operations from classes, exams to
							school events calendar. It provides a powerful
							online community to bring parents, teachers and
